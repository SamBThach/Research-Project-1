...
?>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="Errored_Research_Page.css">
	</head>
	<body>
		<div id ="heading">
			...
			<form action="Data_Collect.php" method="post">
				...
				<p id="error">Duplicate answers or left on default, please try again.</p>
					<h2 id="question">Please match the images with what major you believe it matches. Hover to enlarge images.</h2>
					<tr>
						<td>
					...
					<tr>
						<td>
							...
							<br><br>				
							<select name="Data Science" id="DataScience" name="Data_Science">
								<option value="unselected">Select</option>
								<option value="Cybersecurity">Cybersecurity</option>
								<option value="Computer Engineering">Computer Engineering</option>
								<option value="Applied Maths">Applied Maths</option>
